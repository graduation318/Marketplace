    ...
    public partial class begin : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table => table.PrimaryKey("PK_Characteristics", x => x.Id)
            );
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductCharacteristic", x => new { x.ProductId, x.CharacteristicId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(name: "IX_ProductCharacteristic_CharacteristicId", table: "ProductCharacteristic", column: "CharacteristicId");
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropTable(name: "ProductCharacteristic");
            migrationBuilder.DropTable(name: "Shipments");
            migrationBuilder.DropTable(name: "Characteristics");
